        ...
        <div className='p-5'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='mt-6 flex flex-col items-center' >
            ...
            <div className='flex w-11/12 flex-col space-y-2'>
              ...
              <textarea {...register("userExperience", { required: true })} className='form-style resize-x-none min-h-[130px] w-full text-black' placeholder='Write your experience...'></textarea>
